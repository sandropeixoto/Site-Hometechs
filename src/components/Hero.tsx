  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10 opacity-30">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-emerald-500/10 blur-[120px] rounded-full animate-float"></div>
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-slate-600/10 blur-[100px] rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
            Inovação e <span className="text-emerald-500">Confiança</span> Absoluta
          </h1>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl shadow-emerald-500/10 border border-white/10">
            <img 
              src={heroImg} 
          ...
          {/* Decorative elements */}
          <div className="absolute -top-6 -right-6 w-32 h-32 bg-emerald-500/30 blur-3xl -z-10 rounded-full animate-pulse"></div>
