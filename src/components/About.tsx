      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Sobre a <span className="text-indigo-500">Hometechs</span></h2>
          ...
          >
            ...
            <div className="absolute -bottom-10 -left-10 glass-card p-8 group max-w-xs">
